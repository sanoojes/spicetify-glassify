...
import { NextSongCardStateSchema } from "@app/schemas/appStoreSchema.ts";
import type appStore from "@app/store/appStore.ts";

export const getPlayerNextCard = (
      ...
      },
      {
        ...
        components: [
          ...
          },
          {
            ...
            onChange: (removeNextUp) =>
              state.setPlayerNextCard({ removeNextUp }),
          },
          {
            id: `height`,
            type: "Input",
            ...
            validation: (v) =>
              NextSongCardStateSchema.shape.height.safeParse(v),
          ...
          },
          {
            ...
            validation: (v) =>
              NextSongCardStateSchema.shape.maxWidth.safeParse(v),
          ...
          },
          {
            ...
            validation: (v) =>
              NextSongCardStateSchema.shape.coverArtSize.safeParse(v),
            onChange: (coverArtSize) =>
              state.setPlayerNextCard({ coverArtSize }),
          },
          {
            id: `padding-x`,
            type: "Input",
            ...
            validation: (v) =>
              NextSongCardStateSchema.shape.paddingX.safeParse(v),
          ...
          },
          {
            ...
            validation: (v) =>
              NextSongCardStateSchema.shape.paddingY.safeParse(v),
