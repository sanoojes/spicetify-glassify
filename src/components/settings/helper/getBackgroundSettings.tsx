...
import { DEFAULT_STATE } from "@app/store/appStore.ts";
import z from "zod";
        ...
        components: [
          {
            ...
            onChange: (autoStopAnimation) =>
              state.setBgOptions({ autoStopAnimation }),
          },
        ],
      },
      {
      ...
      },
      {
        ...
        components: [
          ...
          },
          {
            ...
            validation: (value) =>
              z.url({ error: "Invalid URL" }).safeParse(value),
      ...
      },
      {
        ...
        components: [
          ...
          },
          {
            ...
            validation: (value) =>
              CSSFilterSchema.shape.brightness.safeParse(value),
          ...
          },
          {
            ...
            validation: (value) =>
              CSSFilterSchema.shape.contrast.safeParse(value),
          ...
          },
          {
            ...
            validation: (value) =>
              CSSFilterSchema.shape.saturation.safeParse(value),
          ...
          },
          {
            ...
            validation: (value) =>
              CSSFilterSchema.shape.opacity.safeParse(value),
