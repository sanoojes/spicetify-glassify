...
export const getUnderMainViewSettings = (
  ...
  const { filter, type, isScrolling, isScaling, customUrl, customColor } =
    state.umv;
        ...
        components: [
          {
            ...
            tippy: (
              <div>
                ...
                <p>
                  <strong>Custom Image or GIF:</strong> Provide a URL to display
        ...
        components: [
          {
            ...
            value: customUrl,
            validation: (val) =>
              z.url({ error: "Invalid URL" }).safeParse(val).success,
      ...
      },
      {
        ...
        components: [
          ...
          },
          {
            ...
            validation: (val) =>
              CSSFilterSchema.shape.brightness.safeParse(val),
          ...
          },
          {
            ...
            validation: (val) =>
              CSSFilterSchema.shape.saturation.safeParse(val),
