...
import { PlayerStyleSchema } from "@app/schemas/appStoreSchema.ts";
    ...
    return [
      {
        ...
        components: [
          ...
          },
          {
            ...
            validation: (v) =>
              PlayerStyleSchema.shape.sliderHeight.safeParse(v),
            onChange: (sliderHeight) =>
              state.setPlayerStyles(mode, { sliderHeight }),
          },
          {
            id: `padding-x-${mode}`,
            type: "Input",
        ...
        components: [
          {
            ...
            onChangeComplete: (bgColor) =>
              state.setPlayerStyles(mode, { bgColor }),
          },
          {
            id: `bg-opacity-${mode}`,
            type: "Input",
